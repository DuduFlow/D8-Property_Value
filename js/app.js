(function(){
  ...
  function calcA(){
    ...
    setText('a-p1-d',money(d1)); setText('a-p1-relief',money(relief1)); setText('a-p1-invest',wan(investP1)); setText('a-p1-life-cost',wan1(lifeTotal)); setText('a-p2-invest',wan(investP2)); setText('a-p2-life-cost',wan1(firstYearPremium)); setText('a-p2-d',money(d2)); setText('a-p2-relief',money(relief2)); setText('a-policy-cost',money(policyCost));
